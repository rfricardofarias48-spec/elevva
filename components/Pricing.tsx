...
const plans = [
  {
    ...
    isPopular: false,
    link: "https://app.elevva.net.br/register",
  ...
  },
  {
    ...
    isPopular: true,
    tag: "Mais Popular",
    link: "https://app.elevva.net.br/register?plan=pro",
            ...
            >
              ...
              <div className="mb-8 pb-8 border-b border-gray-700/20">
                 <div className="flex items-baseline">
                   {plan.price !== "Personalizado" && plan.price !== "A consultar" && <span className="text-sm font-bold mr-1">R$</span>}
                   <span className={`font-black tracking-tight ${plan.price === "Personalizado" || plan.price === "A consultar" ? 'text-3xl' : 'text-5xl'}`}>{plan.price}</span>
                   {plan.period && <span className={`ml-1 text-sm font-bold tracking-wide ${plan.isPopular ? 'text-gray-400' : 'text-gray-500'}`}>{plan.period}</span>}
                 </div>
              </div>
