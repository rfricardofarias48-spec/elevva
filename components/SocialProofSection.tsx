      ...
      <div className="max-w-[95%] 2xl:max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-[#111827] border border-gray-800 p-8 md:p-10 rounded-[2rem] shadow-xl shadow-gray-200/50 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-gray-200/80 group">
              <div>
                <Quote className="text-brand-green fill-brand-green/20 mb-6" size={32} />
                <p className="text-lg text-gray-400 font-medium leading-relaxed mb-8">"{t.text}"</p>
              </div>
              
              <div className="flex items-center gap-4 mt-auto">
                 <div className="w-12 h-12 rounded-full border-2 border-white shadow-md overflow-hidden shrink-0 group-hover:border-brand-green transition-colors">
