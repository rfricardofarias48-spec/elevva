      ...
      <div className="bg-[#111827] w-full max-w-3xl max-h-[85vh] rounded-2xl shadow-2xl relative z-10 flex flex-col overflow-hidden animate-[float_0.3s_ease-out]">
        ...
        <div className="px-6 py-4 border-b border-gray-800 flex justify-between items-center bg-gray-900/50">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-200">Termos de Uso</h2>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 md:p-8 overflow-y-auto text-gray-400 leading-relaxed text-sm md:text-base space-y-6">
          ...
          <div className="p-4 bg-brand-green/10 rounded-xl border border-brand-green/20 mb-6 flex gap-3 items-start">
             <AlertCircle size={20} className="text-brand-green mt-0.5 shrink-0" />
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">1. Aceitação dos Termos</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">2. Descrição do Serviço</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">3. Uso Responsável e Dados (LGPD)</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">4. Limitações da Inteligência Artificial</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">5. Pagamentos e Cancelamento</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-gray-100 mb-3">6. Propriedade Intelectual</h3>
            <p>
