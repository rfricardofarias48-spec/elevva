...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative bg-white text-brand-black selection:bg-brand-neon selection:text-black">
      ...
      >
        <div className="bg-[#25D366] p-3 rounded-full shadow-neo border-2 border-black flex items-center justify-center hover:bg-green-400">
           <svg viewBox="0 0 24 24" width="32" height="32" className="fill-white" xmlns="http://www.w3.org/2000/svg">
